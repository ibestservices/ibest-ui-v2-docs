    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: `Caliper 卡尺 <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">1.0.4</span>`, link: "/components/caliper/" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: `ReadMore 查看更多 <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">1.0.4</span>`, link: "/components/readMore/" },
          { text: "SectorProgress 扇形进度条", link: "/components/sectorProgress/" },
          { text: `Segmented 分段控制器 <span style="font-size: 12px; padding:2px 4px;color:#3D8AF2;border-radius:4px;border: 1px solid #3D8AF2">1.0.4</span>`, link: "/components/segmented/" },
